...
def render_page_content(pathname):
    ...
    if pathname == '/pru':
        return pruLayout,html.P("Proceso de Pruebas. En esta fase se realizan pruebas unitarias, de integracion y pruebas funcionales para validar la calidad del software y asegurar que cumpla con los requisitos definidos. Indicador:Tasa de defectos ")
    if pathname == '/lan':
        return lanLayout,html.P("Proceso de Lanzamiento. En esta fase se lleva a cabo la implementacion del software en el ambiente de produccion, y se realiza el monitoreo de su desempeno. Indicador: Tiempo de despliegue")
    if pathname == '/dsp':
        return dspLayout,html.P("Proceso de Despliegue. En esta fase se lleva a cabo la distribucion del software en diferentes ambientes y se realizan pruebas de aceptacion y evaluacion de su desempeno. Indicador:Tiempo de ciclo de vida")
    if pathname == '/ope':
        return opLayout,html.P("Proceso de Operacion. En esta fase se realiza el monitoreo y mantenimiento del software, se detectan y solucionan errores y se garantiza su disponibilidad y escalabilidad. Indicador:Uptime")
    if pathname == '/mon':
        return monLayout,html.P("Proceso de Monitoreo. En esta fase se lleva a cabo la recoleccion de informacion sobre el desempeno y la disponibilidad del software y se generan alertas ante situaciones anomalias. Indicador: SLA")
